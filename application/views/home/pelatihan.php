 ...
 <div class="container">
  ...
  <div class="row d-flex ftco-animate justify-content-center">
   <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
    <div class="card">
      <div class="card-body">
        <a href="<?php echo base_url(); ?>Home/pelatihanDetail"><h5 class="text-info">Programmer</h5></a>
        <span class="badge badge-success">CV. Frais Mediatech</span>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua.</p>
        <a href="<?php echo base_url(); ?>Home/pelatihanDetail" class="btn btn-info float-right">Selengkapnya</a>
      </div>
    </div>
  </div>
